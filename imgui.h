...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_CodeSelectNoExt     = 1 << 20   // Crowny-specific flag. Only used for file names. If the InputText() is selected through code only the name of the file will be selected.
